...
<div>
  ...
  <view-wrapper>
    ...
    <mdb-mask class="d-flex justify-content-center gradient">
      <div class="center">
      <mdb-container class="px-md-3 px-sm-0 ">
        <mdb-row>
          <mdb-col md="12" class=" white-text text-center">
            <h3 class="display-3 font-weight-bold mb-0 pt-md-5">ShareMusic </h3>
